...
<html>
    ...
    <body>
        ...
        <div id="show-provider" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.provider}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.provider}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
